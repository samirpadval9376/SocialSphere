...
class AppColor {
  ...
  static const Color divideColor = Color(0xff373737);
  static const Color greyColor = Color(0xffdfdfe1);

  static const Color dialogAlertBackgroundColor = Color(0xff262938);
  static const Color lightGreyColor = Color(0xffA5A5A5);
  ...
  static const MaterialColor primaryMaterialColor = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xff98ABEE),
      100: Color(0xff98ABEE),
      200: Color(0xff98ABEE),
      300: Color(0xff98ABEE),
      400: Color(0xff98ABEE),
      500: Color(0xff98ABEE),
      600: Color(0xff98ABEE),
      700: Color(0xff98ABEE),
      800: Color(0xff98ABEE),
      900: Color(0xff98ABEE),
    },
  );
}
